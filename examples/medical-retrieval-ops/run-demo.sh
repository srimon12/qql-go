...
run_step "15b-search-prefetch-rrf" "exec" "QUERY '$MAIN_QUERY' FROM $COLLECTION LIMIT 5 PREFETCH (QUERY '$MAIN_QUERY' USING 'dense' LIMIT 20, QUERY '$MAIN_QUERY' USING 'sparse' LIMIT 20) FUSION RRF"
run_step "16-select-main" "exec" "SELECT * FROM $COLLECTION WHERE id = $MAIN_ID"
run_step "17-recommend-related" "exec" "QUERY RECOMMEND POSITIVE IDS ($RELATED_ID) FROM $COLLECTION LIMIT 5"
